 ...
 *
 * @param type $param
 * @param type $default Valor por defecto si no existe en $_GET. Si no se pasa, genera un error (parámetro obligatorio para poder ejecutar)
 * @return type
 */
 ...
 * @param type $mensaje
 */
function setflash($mensaje,$url,$class="danger"){
...
function getflash(){
    ...
    return '<div class="alert alert-'.$flash['class'].'">'.$flash['mensaje'].'</div>';
}
